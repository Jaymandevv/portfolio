...
function About() {
  return (
    <div className="space-y-6 leading-8 px-6">
      <p>
      ...
      <p>
        Currently, I&apos;m a Front end developer at <LinkComp url="" name="BigOStack" />, specialized in building a responsive and user friendly website. I also contribution to the projects planning
        to bring the project life
      </p>
